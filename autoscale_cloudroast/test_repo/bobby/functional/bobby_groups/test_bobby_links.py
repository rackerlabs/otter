...
class BobbyLinksTest(BobbyFixture):
    ...
    def test_get_server_group_links(self):
        ...
        returns 200
        """
        get_server_group = self.bobby_client.get_server_group(self.group_id, self.server_id).entity
    ...
    def _verify_get_on_link(self, response_obj, bobby_type=None):
        ...
        if bobby_type is 'server_group':
            get_response = self.bobby_client.get_server_group(response_obj.links.self, None)
