...
migrate-dev-schema:
	PATH=${SCRIPTSDIR}:${PATH} load_cql.py schema/migrations --outfile schema/setup-dev.cql --replication 1 --keyspace ${CONTROL_KEYSPACE} --host ${CASSANDRA_HOST} --port ${CASSANDRA_PORT}
