...
latex_documents = [
  ('index', 'RackspaceAutoScaleApiImagesDeveloperDoc.tex', 'Rackspace Auto Scale API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceAutoScaleApiDeveloperDoc', 'Rackspace Auto Scale API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
    ('index', 'RackspaceAutoscaleDeveloperDoc', 'Rackspace Cloud Auto Scale API Developer Guide',
   'Rackspace', 'RackspaceCloudAutoScaleDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Autoscale service.',
   'Miscellaneous'),
]
