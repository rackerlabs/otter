...
class ScalingGroup(AutoMarshallingModel):
    ...
    def _dict_to_obj(cls, scaling_group_dict):
        ...
        if hasattr(scaling_group, 'scalingPolicies_links'):
            scaling_group.scalingPolicies_links = Links._dict_to_obj(scaling_group.scalingPolicies_links)
...
class Policy(AutoMarshallingModel):
    ...
    def _dict_to_obj(cls, policy_dict):
        ...
        if hasattr(policy, 'webhooks_links'):
            policy.webhooks_links = Links._dict_to_obj(policy.webhooks_links)
